...
const styles = StyleSheet.create({
  container: { flex: 1 },
  background: { flex: 1, justifyContent: 'center', backgroundColor: '#96CBE9' },
  ...
  ratingsContainer: { flexDirection: 'column', alignItems: 'center', marginBottom: 20, paddingHorizontal: 20, paddingVertical: 15, backgroundColor: '#f0f8ff', borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 3, elevation: 3, width: '90%' },
  ratingsTitle: { fontSize: 24, fontWeight: 'bold', color: '#333', marginBottom: 10, textAlign: 'center' },
  sliderContainer: { width: '100%', alignItems: 'center' },
  slider: { width: '90%', height: 40 },
  sliderValue: { fontSize: 18, color: '#0C5481', marginTop: 5 },
  feedbackContainer: { marginTop: 20, padding: 15, backgroundColor: '#f9f9f9', borderRadius: 10, shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1, width: '90%', marginBottom: 20 },
  feedbackTitle: { fontSize: 18, fontWeight: 'bold', marginBottom: 5 },
  feedbackText: { fontSize: 16, color: '#555' },
  feedbackInput: { borderColor: '#ccc', borderWidth: 1, borderRadius: 10, padding: 10, marginTop: 10, height: 100, backgroundColor: '#fff', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.2, shadowRadius: 1 },
  submitButton: { marginTop: 20, backgroundColor: '#0C5481', borderRadius: 10, paddingVertical: 15, paddingHorizontal: 30, alignItems: 'center', elevation: 3 },
